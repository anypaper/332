...
create_ip -name fifo_generator -vendor xilinx.com -library ip -version 13.2 -module_name rx_fifo -dir ./${proj_dir}
set_property -dict [list \
	...
	CONFIG.Empty_Threshold_Assert_Value {4} \
	CONFIG.Empty_Threshold_Negate_Value {5} \
	CONFIG.Enable_Safety_Circuit {true}] [get_ips rx_fifo]
generate_target {instantiation_template} [get_files ./${proj_dir}/rx_fifo/rx_fifo.xci]
generate_target all [get_files  ./${proj_dir}/rx_fifo/rx_fifo.xci]
ipx::package_project -force -import_files ./${proj_dir}/rx_fifo/rx_fifo.xci

create_ip -name fifo_generator -vendor xilinx.com -library ip -version 13.2 -module_name tx_fifo -dir ./${proj_dir}
set_property -dict [list \
	CONFIG.Component_Name {tx_fifo} \
	CONFIG.Fifo_Implementation {Independent_Clocks_Block_RAM} \
	CONFIG.Performance_Options {First_Word_Fall_Through} \
	CONFIG.Input_Data_Width {520} \
	CONFIG.Input_Depth {128} \
	CONFIG.Output_Data_Width {520} \
	CONFIG.Output_Depth {128} \
	CONFIG.Reset_Type {Asynchronous_Reset} \
	CONFIG.Full_Flags_Reset_Value {1} \
	CONFIG.Almost_Full_Flag {true} \
	...
	CONFIG.Empty_Threshold_Assert_Value {4} \
	CONFIG.Empty_Threshold_Negate_Value {5} \
	CONFIG.Enable_Safety_Circuit {true}] [get_ips tx_fifo]
generate_target {instantiation_template} [get_files ./${proj_dir}/tx_fifo/tx_fifo.xci]
generate_target all [get_files  ./${proj_dir}/tx_fifo/tx_fifo.xci]
ipx::package_project -force -import_files ./${proj_dir}/tx_fifo/tx_fifo.xci
## with fifo
...
set_property value_validation_list {512 256 64} [ipx::get_user_parameters C_M_AXIS_DATA_WIDTH -of_objects [ipx::current_core]]
set_property value_validation_type list [ipx::get_user_parameters C_S_AXIS_DATA_WIDTH -of_objects [ipx::current_core]]
set_property value_validation_list {512 256 64} [ipx::get_user_parameters C_S_AXIS_DATA_WIDTH -of_objects [ipx::current_core]]
