...
set design nf_cmac_interface_0
set top nf_cmac_interface_0
...
#####################################
read_verilog "./hdl/cmac0_startup_seq.v"
read_verilog "./hdl/nf_cmac_interface_0.v"
...
create_ip -name cmac_usplus -vendor xilinx.com -library ip -version 2.6 -module_name cmac_interface_0 -dir ./${proj_dir}
set_property -dict [list \
	...
	CONFIG.DIFFCLK_BOARD_INTERFACE {qsfp0_161mhz}] [get_ips cmac_interface_0]
generate_target {instantiation_template} [get_files ./${proj_dir}/cmac_interface_0/cmac_interface_0.xci]
generate_target all [get_files  ./${proj_dir}/cmac_interface_0/cmac_interface_0.xci]
ipx::package_project -force -import_files ./${proj_dir}/cmac_interface_0/cmac_interface_0.xci
