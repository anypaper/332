...
export SUME_FOLDER=${HOME}/work/netfpga/NRG-100G-alpha
#export XILINX_PATH=/opt/Xilinx/Vivado/2019.1
export NF_PROJECT_NAME=super_gadget
...
export NF_DESIGN_DIR=${SUME_FOLDER}/hw/projects/${NF_PROJECT_NAME}
...
export EXTRA_BOARDF_PATH=${HOME}/.Xilinx/Vivado/2019.1/xhub/board_store/XilinxBoardStore/Vivado/2019.1/boards
